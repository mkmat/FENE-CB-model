...
rhop_power       = @(kappa,t) 0.78286*(1+10*(0.068746./kappa)).*t.^(0.0084602*(1+10*(-0.23732./kappa))); %  R2 = 0.71854
rhop_logarithmic = @(kappa,t) 0.77852*(1+10*(0.072193./kappa)) + (0.0073457*(1+10*(-0.21425./kappa)))*log(t); %  R2 = 0.71848
